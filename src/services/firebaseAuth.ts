...
// Gmail OAuth Scopes requested by user
...
// Strictly in-memory caching for OAuth access token (never stored in localStorage or sessionStorage)
  ...
  return onAuthStateChanged(auth, async (user: User | null) => {
    if (user) {
      if (cachedAccessToken) {
        ...
        // Token must be refreshed or acquired via interactive popup
